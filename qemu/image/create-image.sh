...
DIR=chroot
PREINSTALL_PKGS=vim,git,make,openssh-server,curl,tar,gcc,libc6-dev,time,strace,sudo,less,psmisc,selinux-utils,policycoreutils,checkpolicy,selinux-policy-default,firmware-atheros,libssl-dev,libelf-dev,binutils
